page 50805 "TFB Report Sel - NCR"
{

    ApplicationArea = Basic, Suite;
    Caption = 'Report Selection - Non Conformance Request';
    PageType = Worksheet;
    SaveValues = true;
    ...
    layout
    {
        area(content)
        {
            field(ReportUsage; ReportUsage2)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Usage';
                OptionCaption = 'Non-Conformance Request';
    ...
    var
        ReportUsage2: Option "Non-Conformance Request";
    ...
    begin
        ...
        case ReportUsage2 of
            ReportUsage2::"Non-Conformance Request":
                Rec.SetRange(Usage, Rec.Usage::"S.Non.Conformance.Report");
        end;
        Rec.FilterGroup(0);
        CurrPage.Update();
    end;
        ...
        if Rec.GetFilter(Usage) <> '' then begin
            if Evaluate(DummyReportSelections.Usage, Rec.GetFilter(Usage)) then
                case DummyReportSelections.Usage of
                    Rec.Usage::"S.Non.Conformance.Report":
                        ReportUsage2 := ReportUsage2::"Non-Conformance Request"
                end;
            Rec.SetRange(Usage);
        end;
    end;
